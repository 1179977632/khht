...
public class FtpUpload {
    ...
    private static String server = "127.0.0.1";//ip
    private static int port = 8070;//端口
    private static String userName = "ftptest";//登录名
    private static String userPassword = "1996815a";//密码
     ...
     *文件上传工具方法
     */
    public static boolean upload(MultipartFile uploadFile, String ftpPath, String fileName) {
